      ...
      body: Stack(
        children: [
          SingleChildScrollView(
            child: Column(
              children: [
                /// ANIMATED PROFILE CARD (UNCHANGED)
                SlideTransition(
                  position: _slideAnimation,
                  child: _buildProfileCard(size),
                ),
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                "Love traveling, reading, and trying new cuisines...",
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.black87,
                  height: 1.4,
              ...
              /// LIKE / DISLIKE BUTTONS (UNCHANGED)
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  GestureDetector(
