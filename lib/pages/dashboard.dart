...
/// dashboard.dart
/// Final edited version per user requests:
/// - Removed extra bottom spacing inside family cards under the description
/// - Card text color explicitly set to dark (black/near-black) for readability
/// - "Preview" for the user account now shows the user image and uses a light background
/// - Keeps the same light glassy theme, layout, and functionality from before
///
/// Drop this file into your lib/pages/ or lib/ and import/navigate accordingly.
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    TextButton.icon(
                                      onPressed: () {
                                        // preview with image and light background
                                        showDialog(
                                            context: context,
                                            builder: (ctx) {
                                              return Dialog(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(height: 12),
                                                      // Details in darker text for readability
                                                      Align(
                                                        alignment: Alignment.centerLeft,
                                                        child: Column(
                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                          children: [
                                                            Text('Email: ${userInfo['email']}', style: TextStyle(color: Colors.grey.shade800)),
                                                            const SizedBox(height: 6),
                                                            Text('Phone: ${userInfo['phone']}', style: TextStyle(color: Colors.grey.shade800)),
                                                            const SizedBox(height: 6),
                                                            Text('Gotra: ${userInfo['gotra']}', style: TextStyle(color: Colors.grey.shade800)),
                                                            const SizedBox(height: 6),
                                                            Text('Rashi: ${userInfo['rashi']}', style: TextStyle(color: Colors.grey.shade800)),
                                                          ],
                                                        ),
                                                      ),
                                                      const SizedBox(height: 12),
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Primary texts in near-black for readability
                  Text(mem['name'] ?? '',
                      style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
                  ...
                  // ---- Removed extra bottom spacing below the descriptions per request ----
                  // directly show smaller details without extra gap
                  const SizedBox(height: 6),
                  Text('Gotra: ${mem['gotra'] ?? ''}',
                      style:
